        ...
        while(inp != 8){
            ...
            switch(inp) {
                ...
                case 1:
                    ...
                    officer.addVaccine(vName,nDose,gap);
                ...
                case 2:
                    ...
                    officer.registerHospital(hospitalName,pin);
                ...
                case 3:
                    ...
                    officer.registerCitizen(name,age,id);
                ...
                case 4:
                    ...
                    boolean hflag = false;
                    for (int i = 0; i < officer.hospitalLst.size(); i++){
                        if (hID == officer.hospitalLst.get(i).ID){
                            hflag = true;
                        }
                    }
                    if (hflag == false){
                    ...
                    while (n>0){
                        ...
                        System.out.print("\nSelect Vaccine");
                        for (int i = 0; i < officer.vaccineLst.size(); i++){
                            System.out.print("\n->"+officer.vaccineLst.get(i).id+". "+officer.vaccineLst.get(i).name);
                        }
                        System.out.println();
                        int vID = sc.nextInt();

                        if (vID>officer.vaccineLst.size()){
                            System.out.println("\nINVALID Vaccine code !!");
                        }
                        else{
                            officer.addSlot(hID,day,qty,vID);

                            System.out.println("\nSlot added by Hospital "+hID+" for Day: "+day+", Available Quantity: "+qty+" of Vaccine "+officer.vaccineLst.get(vID).name);
                        }
                    }
                ...
                case 7:
                    ...
                    System.out.print("Enter Patient ID: ");
                    long personID = sc.nextLong();
                    officer.checkVaccineStatus(personID);
                    break;
                case 8:
                    // EXIT
